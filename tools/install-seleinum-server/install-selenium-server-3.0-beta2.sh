...
if [ ! -d "/usr/lib/selenium" ]; then
  ...
  echo "Getting selenium server standalone 3.0.0-beta2\n"
  sudo wget http://selenium-release.storage.googleapis.com/3.0-beta2/selenium-server-standalone-3.0-beta2.jar
  sudo mv selenium-server-standalone-3.0-beta2.jar /usr/lib/selenium/selenium-server-standalone-3.0-beta2.jar
  sudo ln -s /usr/lib/selenium/selenium-server-standalone-3.0-beta2.jar /usr/lib/selenium/selenium-server-standalone.jar
